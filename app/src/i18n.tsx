...
const translations = {
  en: {
    ...
    hero: {
      ...
      subheadline:
        'Creator management for creators who want to scale – without the chaos. We handle promotion strategy, sales, marketing, and monetization. You create.',
    ...
    proof: {
      ...
      body:
        'From content calendar to high-ticket upsells, we run the business side so you can show up as the face of your brand. Our analytics-based approach supports steady, measurable progress over time.',
      stats: {
        revenue: 'Revenue generated by our creators',
      ...
      disclaimer: 'Results are not guaranteed. Contact us for a personalized calculation.',
      alt: 'Success story',
    },
    system: {
      headline: {
      ...
      body:
        'We combine content strategy, paid traffic, and 24/7 professional management—so your brand stays consistent and measurable.',
      features: {
        content: {
        ...
        paid: {
          title: 'Paid Traffic',
          description: 'Meta + Reddit + media traffic + native ads with strict compliance and high ROAS.',
        },
        community: {
        ...
        optimization: {
          ...
          description: 'Data analysis-based decisions, A/B testing, and pricing experiments for continuous growth.',
        },
      },
      card: {
        title: '',
    ...
    spotlight: {
      ...
      profile: {
        ...
        values: {
          ...
          growth: '15-30% revenue growth monthly',
          fanBase: 'Over 4,000 paying fans',
        },
      },
      cta: {
        title: 'Real strategy. Real support.',
        body:
          'See how we build a tailored roadmap from content planning to professional management. Results vary by creator and market conditions.',
    ...
    community: {
      headline: {
        line1: "You're not alone",
        line2: 'in this.',
      },
      body:
        'Our creators receive a personalized growth strategy based on analytics, weekly reporting reviews, and a personal assistant who truly responds and provides 24/7 support. Full privacy compliance. Join a community of professionals.',
      pills: {
      ...
      testimonials: [
        {
          quote:
            'They turned my page into a real business. I went from constantly struggling with time to having a professional team that handles everything. I quit my main job and now I rest more.',
          author: 'Lena R.',
        },
        {
          quote:
            'Finally I have time boundaries – I can manage it myself. The team respects my time while maximizing my income.',
          author: 'Sofia M.',
        },
        {
          quote:
            'The team became like family, but very professional. They genuinely care about my success and it shows in the results.',
          author: 'Ava T.',
        },
      ],
      altTop: 'Community',
    ...
    contact: {
      ...
      body:
        "Submit an application. We'll review it and reply within 48 hours. Let's discuss how to turn your content into a sustainable business.",
      infoLabels: {
        email: 'Email',
        whatsapp: 'WhatsApp',
        telegram: 'Telegram',
      ...
      form: {
        ...
        handlePlaceholder: 'Telegram account link for contact',
    ...
    about: {
      ...
      history: {
        ...
        p1:
          'V&E AGENCY is an international marketing agency specializing in promoting content creators on social media, promoting premium content: exclusive materials for your subscribers.',
        p2: 'We have worked with clients since 2023 and help build sustainable, long-term growth strategies.',
      },
      mission: {
        title: 'Our mission',
        p1:
      ...
      whatWeDo: {
        ...
        items: {
          ...
          monetization: {
            label: 'Monetization:',
            text: 'helping increase revenue from premium content.',
          },
          support: {
            label: '24/7 support:',
            text: 'consultations and manager assistance.',
          },
        },
      },
      team: {
        ...
        items: {
          ...
          trafficManagers: {
            ...
            text: 'professionals in attracting new fans, developing social media based on analytics.',
          },
          content: {
            label: 'Content managers:',
            text: 'specialists in visual content development, consultants and personal support for each creator.',
          },
          salesManagers: {
            label: 'Sales managers:',
            text: 'specially trained experts with knowledge of sales funnels and long-term fan engagement.',
          },
          hr: {
            label: 'HR department:',
            text: 'search and hunting for experts with specialized qualifications.',
          },
          analysts: {
            label: 'Analysts:',
      ...
      why: {
        title: 'Why choose us?',
        items: [
          'Over three years of industry experience',
          'Professionally growing team (120+ employees)',
          'Individual approach to each creator',
          'Transparent work',
          '24/7 support',
        ],
      },
  ...
  ru: {
    ...
    hero: {
      ...
      subheadline:
        'Менеджмент для креаторов, которые хотят масштабироваться – без хаоса. Мы берем на себя стратегию продвижения, продажи, маркетинг и монетизацию. Ты создаешь.',
    ...
    proof: {
      ...
      body:
        'От контент-календаря до дорогих апсейлов – мы ведем бизнес-часть, чтоб ты могла быть лицом своего бренда. Наш подход на аналитике данных дает стабильный, измеримый рост со временем.',
      stats: {
        revenue: 'Доход, полученный нашими креаторами',
      ...
      disclaimer: 'Результаты не гарантированы. Для получения индивидуального расчета свяжитесь с нами',
      alt: 'История успеха',
    },
    system: {
      headline: {
      ...
      body:
        'Мы объединяем стратегию контента, платный трафик и 24/7 профессиональный менеджмент — чтобы бренд был стабильным и измеримым.',
      features: {
        content: {
        ...
        paid: {
          ...
          description: 'Meta + Reddit + медийный трафик + нативная реклама с жестким соблюдением правил и высоким ROAS.',
        },
        community: {
        ...
        optimization: {
          ...
          description: 'Решения на основе анализа данных, A/B тесты и эксперименты с ценами для постоянного роста.',
        },
      },
      card: {
        title: '',
    ...
    spotlight: {
      ...
      profile: {
        ...
        values: {
          ...
          growth: 'Рост на 15-30% выручки ежемесячно',
          fanBase: 'Более 4000 платежеспособных фанатов',
        },
      },
      cta: {
        title: 'Реальная стратегия. Реальная поддержка.',
        body:
          'Посмотрите, как мы создаем индивидуальную дорожную карту от планирования контента до профессионального менеджмента. Результаты зависят от креатора и рынка.',
    ...
    community: {
      ...
      body:
        'Наши креаторы получают индивидуальную стратегию роста на основе анализа, сверки еженедельной отчетности, а также персонального помощника, который действительно отвечает и оказывает поддержку 24/7. Полное соблюдение конфиденциальности. Присоединяйся к сообществу профессионалов.',
      pills: {
        network: 'Стратегия роста',
        calls: 'Конфиденциальность',
        support: 'Поддержка 24/7',
      },
      testimonials: [
        {
          quote:
            'Они превратили мою страницу в настоящий бизнес. Я перешла от состояния постоянной нехватки времени к профессиональной команде, которая все берет на себя. Я ушла с основной работы и теперь больше отдыхаю.',
          author: 'Lena R.',
        },
        {
          quote:
            'Наконец появились границы по времени – я могу сама управлять им. Команда уважает мое время и при этом максимизирует доход.',
          author: 'Sofia M.',
        },
        {
          quote:
            'Команда стала как семья, но при этом очень профессиональная. Они искренне заботятся о моем успехе и это видно по результатам.',
          author: 'Ava T.',
        },
      ],
      altTop: 'Сообщество',
    ...
    contact: {
      headline: {
        line1: 'Готова к росту?',
        line2: '',
      },
      body:
        'Подайте заявку. Мы рассмотрим её и ответим в течении 48 часов. Давайте обсудим, как превратить ваш контент в устойчивый бизнес.',
      infoLabels: {
        email: 'Email',
        whatsapp: 'WhatsApp',
        telegram: 'Telegram',
      ...
      form: {
        ...
        handlePlaceholder: 'Ссылка на Телеграм аккаунт для связи',
    ...
    about: {
      ...
      history: {
        ...
        p1:
          'V&E AGENCY — международное маркетинговое агентство, специализирующееся на продвижении контент-креаторов в социальных сетях, продвигая премиум контент: эксклюзивные материалы для ваших подписчиков.',
        p2: 'Мы работаем с клиентами с 2023 года и помогаем выстраивать устойчивые, долгосрочные стратегии роста.',
      },
      mission: {
        title: 'Наша миссия',
        p1:
      ...
      whatWeDo: {
        ...
        items: {
          ...
          monetization: {
            label: 'Монетизация:',
            text: 'помощь в увеличении доходов от премиум-контента.',
          },
          support: {
            label: 'Поддержка 24/7:',
            text: 'консультации и помощь менеджера.',
          },
        },
      },
      team: {
        ...
        items: {
          ...
          trafficManagers: {
            label: 'Менеджеры по трафику:',
            text: 'профессионалы в привлечении новых фанов, развитии социальных сетей на основе аналитических показателей.',
          },
          content: {
            label: 'Менеджеры по контенту:',
            text: 'специалисты в разработке визуального контента, консультанты и личная поддержка каждого креатора.',
          },
          salesManagers: {
            label: 'Менеджеры по продажам:',
            text: 'специально обученные эксперты со знанием воронки продаж и долгосрочной работе с фанами.',
          },
          hr: {
            label: 'HR отдел:',
            text: 'поиск и хантинг экспертов узкопрофильных квалификаций.',
          },
          analysts: {
            label: 'Аналитики:',
      ...
      why: {
        ...
        items: [
          'Опыт в индустрии более трех лет',
          'Профессионально растущая команда (более 120 сотрудников)',
          'Индивидуальный подход к каждому креатору',
  ...
  es: {
    ...
    proof: {
      ...
      disclaimer: 'Los resultados no estan garantizados. Contactenos para un calculo personalizado.',
    ...
    system: {
      ...
      body:
        'Combinamos estrategia de contenido, trafico de pago y gestion profesional 24/7 para que tu marca sea consistente y medible.',
      features: {
        content: {
        ...
        paid: {
          ...
          description: 'Meta + Reddit + trafico de medios + anuncios nativos con cumplimiento estricto y alto ROAS.',
        },
        community: {
        ...
        optimization: {
          ...
          description: 'Decisiones basadas en analisis de datos, pruebas A/B y experimentos de precios para crecimiento continuo.',
        },
      },
      card: {
        title: '',
    ...
    spotlight: {
      ...
      profile: {
        ...
        values: {
          ...
          growth: 'Crecimiento del 15-30% en ingresos mensualmente',
          fanBase: 'Mas de 4,000 fans que pagan',
        },
      },
      cta: {
        title: 'Estrategia real. Apoyo real.',
        body:
          'Mira como construimos un plan a medida desde la planificacion de contenido hasta la gestion profesional. Los resultados varian segun el creador y el mercado.',
    ...
    community: {
      ...
      body:
        'Nuestros creadores reciben una estrategia de crecimiento personalizada basada en análisis, revisión de informes semanales, y un asistente personal que realmente responde y brinda soporte 24/7. Total cumplimiento de privacidad. Únete a una comunidad de profesionales.',
      pills: {
        network: 'Estrategia de crecimiento',
        calls: 'Privacidad',
      ...
      testimonials: [
        {
          quote:
            'Convirtieron mi página en un negocio real. Pasé de estar constantemente sin tiempo a tener un equipo profesional que se encarga de todo. Dejé mi trabajo principal y ahora descanso más.',
          author: 'Lena R.',
        },
        {
          quote:
            'Finalmente tengo límites de tiempo – puedo gestionarlo yo misma. El equipo respeta mi tiempo mientras maximiza mis ingresos.',
          author: 'Sofia M.',
        },
        {
          quote:
            'El equipo se volvió como familia, pero muy profesional. Realmente se preocupan por mi éxito y se nota en los resultados.',
          author: 'Ava T.',
        },
      ],
      altTop: 'Comunidad',
    ...
    contact: {
      headline: {
        line1: 'Lista para crecer?',
        line2: '',
      },
      body:
        'Envía una solicitud. La revisaremos y responderemos en 48 horas. Hablemos de cómo convertir tu contenido en un negocio sostenible.',
      infoLabels: {
        email: 'Email',
        whatsapp: 'WhatsApp',
        telegram: 'Telegram',
      ...
      form: {
        ...
        handlePlaceholder: 'Enlace de cuenta de Telegram para contacto',
        goalsLabel: 'Cuéntanos tus metas',
    ...
    about: {
      ...
      history: {
        ...
        p1:
          'V&E AGENCY es una agencia de marketing internacional especializada en promocionar creadores de contenido en redes sociales, promoviendo contenido premium: materiales exclusivos para tus suscriptores.',
        p2: 'Trabajamos con clientes desde 2023 y ayudamos a construir estrategias de crecimiento sostenibles a largo plazo.',
      },
      mission: {
      ...
      whatWeDo: {
        ...
        items: {
          strategy: {
            ...
            text: 'planificación de publicaciones y formatos de contenido.',
          },
          promotion: {
            label: 'Promoción:',
            text: 'publicidad en redes sociales y plataformas de pago.',
          },
          accounts: {
            label: 'Gestión de cuentas:',
            text: 'gestión y optimización de perfiles.',
          },
          monetization: {
            label: 'Monetización:',
            text: 'apoyo para aumentar ingresos por contenido premium.',
          },
          support: {
            label: 'Soporte 24/7:',
            text: 'consultas y asistencia del manager.',
          },
        },
      },
      team: {
        ...
        items: {
          ...
          trafficManagers: {
            label: 'Managers de tráfico:',
            text: 'profesionales en atraer nuevos fans, desarrollar redes sociales basadas en análisis.',
          },
          content: {
            label: 'Managers de contenido:',
            text: 'especialistas en desarrollo de contenido visual, consultores y soporte personal para cada creador.',
          },
          salesManagers: {
            label: 'Managers de ventas:',
            text: 'expertos especialmente capacitados con conocimiento de embudos de ventas y trabajo a largo plazo con fans.',
          },
          hr: {
            label: 'Departamento de RR.HH.:',
            text: 'búsqueda y captación de expertos con calificaciones especializadas.',
          },
          analysts: {
            label: 'Analistas:',
            text: 'expertos en análisis de datos y optimización.',
          },
        },
      },
      why: {
        ...
        items: [
          'Más de tres años de experiencia en la industria',
          'Equipo en crecimiento profesional (más de 120 empleados)',
          'Enfoque individual para cada creador',
